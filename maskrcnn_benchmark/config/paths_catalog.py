...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "20DS_VG_VGKB": {
            ...
            # "clip_data_file": "datasets/vg/20/20vg_clip_logits.pk",
        },
        "20DS_VG_CCKB": {
            "img_dir": "vg/VG_100K",
            "roidb_file": "vg/20/VG-SGG-with-attri.h5",
    ...
    def get(name, cfg):
        if "coco" in name:
        ...
        elif ("CP" in name) or ("VG" in name) or ('GQA' in name) or ("VRD" in name):
            print(name)
            ...
            if ("DS" in name) or ("CP" in name):
                if cfg.WSUPERVISE.CLIP_FILE is not None:
                    args['clip_data_file'] = cfg.WSUPERVISE.CLIP_FILE
                if cfg.HIERARCHY.HIERARCHICAL_FILE is not None:
                    args["hierarchical_file"] = cfg.HIERARCHY.HIERARCHICAL_FILE
                return dict(
