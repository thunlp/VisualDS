# pretrain
OUTPATH=$EXP/20/predcls/semi/m_step1_pretrain
mkdir -p $OUTPATH
...
# finetune
OUTPATH=$EXP/20/predcls/semi/m_step1
mkdir -p $OUTPATH
cp $EXP/20/predcls/semi/m_step1_pretrain/last_checkpoint  $OUTPATH/last_checkpoint   # finetune based  on pretrained model
