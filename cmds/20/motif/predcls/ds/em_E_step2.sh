OUTPATH=$EXP/20/predcls/ds/e_step2
mkdir -p $OUTPATH
cp $EXP/20/predcls/ds/m_step1/last_checkpoint    $OUTPATH/last_checkpoint #use m_step1 model to relable DS data
...
cd $OUTPATH
python score.py
python cut_off.py 0.25 # use all relabeled DS data
cd $SG
