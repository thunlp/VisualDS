# pretrain
OUTPATH=$EXP/20/sgcls/semi/m_step2_pretrain
mkdir -p $OUTPATH
...
# finetune
OUTPATH=$EXP/20/sgcls/semi/m_step2
mkdir -p $OUTPATH
cp $EXP/20/sgcls/semi/m_step2_pretrain/last_checkpoint  $OUTPATH/last_checkpoint   # finetune based  on pretrained model
